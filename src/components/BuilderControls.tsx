...
const generateToySTL = (params: BuilderParams): string => {
  ...
  let stl = "solid bad_custom_toy\n";
  const calcNormal = (p1: {x:number,y:number,z:number}, p2: {x:number,y:number,z:number}, p3: {x:number,y:number,z:number}) => {
